...
f2.C <- ggplot2::ggplot(data = Rgenes |>
  ...
  ggplot2::facet_wrap(~R, labeller = \(x) "Pi-d", ncol = 1) +
...
ggplot2::ggsave(plot = f2.ABC, filename = here::here("figures", "Figure_S2.png"),
                dpi = 600, width = 5, height = 2.25, scale = 1.75)
